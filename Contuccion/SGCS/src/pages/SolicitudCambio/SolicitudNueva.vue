    ...
    methods: {       
        ...
        GenerarPdf(){
           ...
           // doc.triangle(100, 100, 110, 100, 120, 130, 'FD');
            ...
            doc.text(30,90, me.nombre_proyecto);
